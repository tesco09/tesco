    ...
    return (
        <>
            ...
            <div className="flex flex-row items-center justify-between w-[90%]">
                ...
                <button className="w-[20%] text-center bg-gray-100 p-[4px] border-[1.5px] text-gray-500  rounded-full text-[12px] font-bold" onClick={() => handleCopy(`https://www.tesco-network.com/signup/${userData?.generatedId}`)}>
